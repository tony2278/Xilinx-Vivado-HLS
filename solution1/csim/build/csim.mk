# ==============================================================
# File generated on Sun Mar 17 11:38:09 +0800 2019
...
HLS_SOURCES = ../../../test.cpp ../../../hls_sobel.cpp
...
$(ObjDir)/hls_sobel.o: ../../../hls_sobel.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../hls_sobel.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/hls_sobel.d
